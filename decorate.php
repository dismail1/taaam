...
{ 
  ...
  $collection = $xpath->query("/collection/decorate[title='$title']");
...
{ 
  ...
  echo "<div class=\"row-fluid\"><div class=\"span12\"><h4>Steps</h4></div></div>";
  $steps = $recipe->getElementsByTagName( "steps" );
  echo "<ol>";
  foreach( $steps as $step ) 
{ 
    $valueStep = $step->getAttribute('step'); 

    $valueUri = $step->getAttribute( 'uri' ); 

    
    echo "<li><div class=\"row-fluid\"><div class=\"span8\"> $valueStep  </div><div class=\"span4\"><img src=\"$valueUri\" width=\"200px\" ></div></div></li>"; 
}
echo "</ol>";
